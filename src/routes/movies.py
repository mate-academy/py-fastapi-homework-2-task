...
from schemas.movies import Movie, MoviesList, MovieDetail, MovieCreate, MovieUpdate
...
def update_film(movie_id: int, movie: MovieUpdate, db: Session = Depends(get_db)):
